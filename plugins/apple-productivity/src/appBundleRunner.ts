...
export function appBundlePathForExecutable(executablePath: string): string | undefined {
...
export function helperContainerTmpDir(bundleId: string | undefined): string {
  if (!bundleId) {
    return tmpdir();
  }
...
export async function runAppBundleHelper<E extends Error>(options: AppBundleRunOptions<E>): Promise<string> {
...
function bundleIdForAppPath(appPath: string): string | undefined {
...
interface OpenAppBundleOptions<E extends Error> extends AppBundleRunOptions<E> {
  appPath: string;
  inputPath: string;
  outputPath: string;
  errorPath: string;
...
function openAppBundle<E extends Error>(options: OpenAppBundleOptions<E>): Promise<string> {
...
async function finishAppBundleRun<E extends Error>(
  options: OpenAppBundleOptions<E>,
  code: number | null,
  stdout: string,
  stderr: string
): Promise<string> {
