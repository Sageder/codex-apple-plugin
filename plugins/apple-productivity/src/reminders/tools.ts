...
import { RemindersService } from "./remindersService.js";
import {
  remindersCompleteSchema,
  remindersCreateSchema,
  remindersListListsSchema,
  remindersMoveSchema,
  remindersReadSchema,
...
export function registerRemindersTools(server: McpServer, reminders: RemindersService): void {
  server.registerTool(
