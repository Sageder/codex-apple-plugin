...
export const mailSearchSchema = z
    .object({
    ...
    recipient: z
        .string()
        .optional()
        .describe("Match recipient name or address. Use this for questions like what did I send to someone."),
    ...
    .strict();
export const mailRetrieveContextSchema = mailSearchSchema
    .extend({
    topK: z.number().int().positive().max(20).optional(),
    maxBodyChars: z.number().int().positive().max(100000).optional()
})
    .strict();
export const mailReadSchema = z
    .object({
...
export const mailComposeSchema = z
    ...
    .strict();
export const mailSendSchema = mailComposeSchema
    .extend({
    confirm: z.boolean().optional(),
    dryRun: z.boolean().optional()
})
    .strict();
export const mailWriteSchema = z
    .object({
...
export const mailUndoMoveSchema = z
    .object({
